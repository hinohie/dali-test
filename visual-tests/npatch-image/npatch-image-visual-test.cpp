...
enum TestStep
{
  CREATE_ASYNC_PREMULTIPLIED_STEP,
  TEST_ASYNC_PREMULTIPLIED_STEP,
  CREATE_SYNC_PREMULTIPLIED_STEP,
  TEST_SYNC_PREMULTIPLIED_STEP,
  CREATE_MIXED_PREMULTIPLIED_STEP,
  TEST_MIXED_PREMULTIPLIED_STEP,
  CREATE_ASYNC_NO_PREMULTIPLIED_STEP,
  TEST_ASYNC_NO_PREMULTIPLIED_STEP,
  CREATE_SYNC_NO_PREMULTIPLIED_STEP,
  TEST_SYNC_NO_PREMULTIPLIED_STEP,
  CREATE_MIXED_NO_PREMULTIPLIED_STEP,
  TEST_MIXED_NO_PREMULTIPLIED_STEP,
  NUMBER_OF_STEPS,
};
constexpr static int TERMINATE_RUNTIME = 20 * 1000; // 20 seconds
...
public:
  ...
  void OnInit( Application& application )
  {
    ...
    mTerminateTimer.TickSignal().Connect(this, &NPatchImageVisualTest::OnTerminateTimer);
...
private:
  ...
  {
    // Visual Test Timout!
    printf("TIMEOUT npatch-image-visual.test spend more than %d ms\n",TERMINATE_RUNTIME);
  ...
  void PerformTest()
  {
    ...
    switch(gTestStep)
    {
      case CREATE_ASYNC_PREMULTIPLIED_STEP:
      case CREATE_SYNC_PREMULTIPLIED_STEP:
      case CREATE_MIXED_PREMULTIPLIED_STEP:
      case CREATE_ASYNC_NO_PREMULTIPLIED_STEP:
      case CREATE_SYNC_NO_PREMULTIPLIED_STEP:
      case CREATE_MIXED_NO_PREMULTIPLIED_STEP:
      {
        CreateVisuals(
          (gTestStep == CREATE_ASYNC_PREMULTIPLIED_STEP) || (gTestStep == CREATE_MIXED_PREMULTIPLIED_STEP) || (gTestStep == CREATE_ASYNC_NO_PREMULTIPLIED_STEP || gTestStep == CREATE_MIXED_NO_PREMULTIPLIED_STEP),
          (gTestStep == CREATE_SYNC_PREMULTIPLIED_STEP) || (gTestStep == CREATE_MIXED_PREMULTIPLIED_STEP) || (gTestStep == CREATE_SYNC_NO_PREMULTIPLIED_STEP || gTestStep == CREATE_MIXED_NO_PREMULTIPLIED_STEP),
          (gTestStep == CREATE_ASYNC_PREMULTIPLIED_STEP) || (gTestStep == CREATE_SYNC_PREMULTIPLIED_STEP) || (gTestStep == CREATE_MIXED_PREMULTIPLIED_STEP));
        break;
      }
      case TEST_ASYNC_PREMULTIPLIED_STEP:
      case TEST_SYNC_PREMULTIPLIED_STEP:
      case TEST_MIXED_PREMULTIPLIED_STEP:
      case TEST_ASYNC_NO_PREMULTIPLIED_STEP:
      case TEST_SYNC_NO_PREMULTIPLIED_STEP:
      case TEST_MIXED_NO_PREMULTIPLIED_STEP:
      {
