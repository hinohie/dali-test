...
private:
  ...
  void MultiLanguageOutlineTest()
  {
    ...
    mTextLabel[0].SetPosition( 20.f, 20.f);
    ...
    mTextLabel[1].SetPosition( 0.f, 100.f);
    ...
    mTextLabel[2].SetPosition( 20.f, 200.f);
    ...
    mTextLabel[3].SetPosition( 20.f, 330.f);
    ...
    mTextLabel[4].SetPosition( 0.f, 470.f);
    ...
    mTextLabel[5].SetPosition( 20.f, 605.f);
